...
import ModalNewTask from "@/app/(components)/ModelNewTask";
...
const ReusablePriorityPage = ({ priority }: Props) => {
  ...
  console.log("Tasks from API:", tasks); // Log the tasks here
  ...
  console.log("Filtered Tasks:", filteredTasks); // Ensure filtering is working as expected
